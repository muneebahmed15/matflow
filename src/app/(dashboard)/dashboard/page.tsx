...
import { getDashboardStatsAction } from '@/app/(dashboard)/actions';
...
export default function DashboardPage() {
  ...
  return (
    <div className="p-6 md:p-8 max-w-6xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-extrabold">{stats.gymName}</h1>
        ...
        {[
          {
            ...
            sub: 'One-tap attendance tracking',
          },
          {
            href: '/members/new',
            icon: Users,
          ...
          },
          {
            ...
            sub: 'Digital e-signature waivers',
          },
          {
            href: '/plans',
            icon: CreditCard,
            ...
            sub: 'Create and manage billing plans',
          },
