...
export async function POST(req: NextRequest) {
  ...
  if (action === 'start') {
    ...
    const welcome = await getAiChatWelcomeContext(parsed.data.gym_id);
    return NextResponse.json({
      conversation_id: conversationId,
      conversation_token: conversationToken,
      off_hours: welcome.offHours,
      off_hours_message: welcome.offHoursMessage,
    });
  }
